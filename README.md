...
4.  Download the APIM lab GitHub repository *apimlab.scm.azure-api.net.zip* from here (https://github.com/prchanda/apimlab/blob/master/apimlab.scm.azure-api.net.zip) and extract it in your local drive.
